...
#INCLUDE       	<OPERATION.INC>
	...
	PUBLIC         	_agcTab
	EXTERN         	_hw2000b_irq_request
	EXTERN         	__ack_count
	EXTERN         	_RX_OK_flag
	PUBLIC         	_reg_read_write_test
D__项目工程_RF_NODC_V1_0_SOFT_src_hw2000b_cconst0#	CSEG           
	ADD            	PCRL,	1
_agcTab
...
_hw2000b_init_250k_i_41	EQU            	_hw2000b_init_250kDATA + 0X0		; Bank 0
_hw2000b_init_250k_#T20876_42	EQU            	_hw2000b_init_250kDATA + 0X1		; Bank 0
_hw2000b_init_250k_#T20889_42	EQU            	_hw2000b_init_250kDATA + 0X1		; Bank 0
_hw2000b_init_250k_#T20891_42	EQU            	_hw2000b_init_250kDATA + 0X3		; Bank 0
_hw2000b_init_250k_#T20892_42	EQU            	_hw2000b_init_250kDATA + 0X1		; Bank 0
_hw2000b_tx_data_reg_71	EQU            	_hw2000b_tx_dataDATA + 0X0		; Bank 0
_hw2000b_tx_data_#T21388_71	EQU            	_hw2000b_tx_dataDATA + 0X0		; Bank 0
_hw2000b_tx_data_#T21412_71	EQU            	_hw2000b_tx_dataDATA + 0X2		; Bank 0
...
; {
#line 56	D:\项目工程\RF-NODC-V1.0-SOFT\src\hw2000b.c ; 	CE = 0;
	CLR            	BKSR
;   56:(    ASGN_0,          0 ,            ,       PB7)

; ITemplate_CLR_0_TMP
	BCC            	(_PB7_0)/8,	(_PB7_0)%8
#line 57	D:\项目工程\RF-NODC-V1.0-SOFT\src\hw2000b.c ; 	delay_ms(3);
;   57:(    PARA_2,          3 ,            ,        ms)
...
; ITemplate_CALL
	...
	SEGMENTSEL     	$
#line 58	D:\项目工程\RF-NODC-V1.0-SOFT\src\hw2000b.c ; 	CE = 1;
;   58:(    ASGN_0,          1 ,            ,       PB7)

; ITemplate_SET_0_TMP
	BSS            	(_PB7_0)/8,	(_PB7_0)%8
#line 59	D:\项目工程\RF-NODC-V1.0-SOFT\src\hw2000b.c ; 	delay_ms(3);
;   59:(    PARA_2,          3 ,            ,        ms)
...
; ITemplate_CALL
	...
	CALL           	_delay_ms		; Bank 0		; ShBank 0
	SEGMENTSEL     	$
#line 60	D:\项目工程\RF-NODC-V1.0-SOFT\src\hw2000b.c ; }
;   60:(       RET,            ,            ,          )
...
; {
;     uint8_t i;
#line 154	D:\项目工程\RF-NODC-V1.0-SOFT\src\hw2000b.c ; 	hw2000b_write_reg(0x4C, 0x55AA);		//open write project
	CLR            	BKSR
;  154:(    PARA_1,         76 ,            ,      addr)
...
; ITemplate_CALL
	...
	SEGMENTSEL     	$
#line 155	D:\项目工程\RF-NODC-V1.0-SOFT\src\hw2000b.c ; 	for (i = 0; i < 18; i++) {
;  155:(    ASGN_1,          0 ,            ,         i)

; ITemplate_CLR1_4_TMP
	SECTION        	0x1
	CLR            	(_hw2000b_init_250k_i_41) & 0X7F		; Bank 1
;  155:(     LABEL,    #L20848 ,            ,          )
...
; ITemplate_JGE1_4U
	MOVI           	0x12
	SUB            	(_hw2000b_init_250k_i_41) & 0X7F,	0x0		; Bank 1
	JBC            	PSW,	0x0
	GOTO           	#L20849
#line 156	D:\项目工程\RF-NODC-V1.0-SOFT\src\hw2000b.c ;         hw2000b_write_reg(0x50 + i, agcTab[i]);
;  156:(     ADD_1,          i ,         80 ,      addr)

; ITemplate_ADD1_4
	MOV            	(_hw2000b_init_250k_i_41) & 0X7F,	0x0		; Bank 1
	ADDI           	0x50
	MOVA           	(_hw2000b_write_regDATA+0X0) & 0X7F		; Bank 1
;  156:(   CVUC_SI,          i ,            ,   #T20889)

; ITemplate_CVTMS_U
	CLR            	(_hw2000b_init_250k_#T20889_42+0x1) & 0X7F		; Bank 1
	MOV            	(_hw2000b_init_250k_i_41) & 0X7F,	0x0		; Bank 1
	MOVA           	(_hw2000b_init_250k_#T20889_42) & 0X7F		; Bank 1
;  156:(    LSH_2S,    #T20889 ,          1 ,   #T20891)

; ITemplate_LSH1_4_1
	BCC            	PSW,	0x0
	RL             	(_hw2000b_init_250k_#T20889_42) & 0X7F,	0x0		; Bank 1
	MOVA           	(_hw2000b_init_250k_#T20891_42) & 0X7F		; Bank 1
	RL             	(_hw2000b_init_250k_#T20889_42+0x1) & 0X7F,	0x0		; Bank 1
	MOVA           	(_hw2000b_init_250k_#T20891_42+0x1) & 0X7F		; Bank 1
;  156:(     ADD_2,    #T20891 , (agcTab.0) ,   #T20892)

; ITemplate_ADD1_4
	MOV            	(_hw2000b_init_250k_#T20891_42) & 0X7F,	0x0		; Bank 1
	ADDI           	(_agcTab<<1)
	MOVA           	(_hw2000b_init_250k_#T20892_42) & 0X7F		; Bank 1
	MOV            	(_hw2000b_init_250k_#T20891_42+0x1) & 0X7F,	0x0		; Bank 1
	ADDCI          	HIGH((_agcTab<<1))
	MOVA           	(_hw2000b_init_250k_#T20892_42+0x1) & 0X7F		; Bank 1
;  156:(    PARA_2,   *#T20892 ,            ,     value)

; ITemplate_GetRomRef
	MOV            	(_hw2000b_init_250k_#T20892_42) & 0X7F,	0x0		; Bank 1
	MOVAR          	CSEG_PTR		; Bank 0
	MOV            	(_hw2000b_init_250k_#T20892_42+0x1) & 0X7F,	0x0		; Bank 1
...
; ITemplate_INC_1_TMP
	SECTION        	0x1
	INC            	(_hw2000b_init_250k_i_41) & 0X7F		; Bank 1
#line 157	D:\项目工程\RF-NODC-V1.0-SOFT\src\hw2000b.c ;     }
;  157:(       JMP,            ,            ,   #L20848)
...
; ITemplate_LABEL
#L20849
#line 159	D:\项目工程\RF-NODC-V1.0-SOFT\src\hw2000b.c ; 	hw2000b_write_reg(0x0F, 0xFC04);//ES7W8020
;  159:(    PARA_1,         15 ,            ,      addr)
...
; ITemplate_CALL
	...
	CALL           	_hw2000b_write_reg		; Bank 0		; ShBank 0
	SEGMENTSEL     	$
#line 161	D:\项目工程\RF-NODC-V1.0-SOFT\src\hw2000b.c ;     hw2000b_write_reg(0x01, 0x4D58);//ES7W8020
;  161:(    PARA_1,          1 ,            ,      addr)
...
; ITemplate_CALL
	...
	CALL           	_hw2000b_write_reg		; Bank 0		; ShBank 0
	SEGMENTSEL     	$
#line 162	D:\项目工程\RF-NODC-V1.0-SOFT\src\hw2000b.c ;     hw2000b_write_reg(0x02, 0x04CC);//ES7W8020
;  162:(    PARA_1,          2 ,            ,      addr)
...
; ITemplate_CALL
	...
	CALL           	_hw2000b_write_reg		; Bank 0		; ShBank 0
	SEGMENTSEL     	$
#line 163	D:\项目工程\RF-NODC-V1.0-SOFT\src\hw2000b.c ;     hw2000b_write_reg(0x08, 0xB6C4);//ES7W8020
;  163:(    PARA_1,          8 ,            ,      addr)
...
; ITemplate_CALL
	...
	CALL           	_hw2000b_write_reg		; Bank 0		; ShBank 0
	SEGMENTSEL     	$
#line 164	D:\项目工程\RF-NODC-V1.0-SOFT\src\hw2000b.c ; 	hw2000b_write_reg(0x09, 0xB442);//ES7W8020  
;  164:(    PARA_1,          9 ,            ,      addr)
...
; ITemplate_CALL
	...
	CALL           	_hw2000b_write_reg		; Bank 0		; ShBank 0
	SEGMENTSEL     	$
#line 165	D:\项目工程\RF-NODC-V1.0-SOFT\src\hw2000b.c ;     hw2000b_write_reg(0x4A, 0x326C);//ES7W8020 
;  165:(    PARA_1,         74 ,            ,      addr)
...
; ITemplate_CALL
	...
	CALL           	_hw2000b_write_reg		; Bank 0		; ShBank 0
	SEGMENTSEL     	$
#line 167	D:\项目工程\RF-NODC-V1.0-SOFT\src\hw2000b.c ;     hw2000b_write_reg(0x0B, 0x0873);//ES7W8020   tx power:8dBm
;  167:(    PARA_1,         11 ,            ,      addr)
...
; ITemplate_CALL
	...
	CALL           	_hw2000b_write_reg		; Bank 0		; ShBank 0
	SEGMENTSEL     	$
#line 168	D:\项目工程\RF-NODC-V1.0-SOFT\src\hw2000b.c ;     hw2000b_write_reg(0x49, 0x1330);//ES7W8020   
;  168:(    PARA_1,         73 ,            ,      addr)
...
; ITemplate_CALL
	...
	CALL           	_hw2000b_write_reg		; Bank 0		; ShBank 0
	SEGMENTSEL     	$
#line 169	D:\项目工程\RF-NODC-V1.0-SOFT\src\hw2000b.c ;     hw2000b_write_reg(0x27, 0x8F20);//ES7W8020   
;  169:(    PARA_1,         39 ,            ,      addr)
...
; ITemplate_CALL
	...
	CALL           	_hw2000b_write_reg		; Bank 0		; ShBank 0
	SEGMENTSEL     	$
#line 170	D:\项目工程\RF-NODC-V1.0-SOFT\src\hw2000b.c ; 	hw2000b_write_reg(0x48, 0x4300);//ES7W8020
;  170:(    PARA_1,         72 ,            ,      addr)
...
; ITemplate_CALL
	...
	CALL           	_hw2000b_write_reg		; Bank 0		; ShBank 0
	SEGMENTSEL     	$
#line 171	D:\项目工程\RF-NODC-V1.0-SOFT\src\hw2000b.c ; 	hw2000b_write_reg(0x26, 0x000C);//ES7W8020
;  171:(    PARA_1,         38 ,            ,      addr)
...
; ITemplate_CALL
	...
	CALL           	_hw2000b_write_reg		; Bank 0		; ShBank 0
	SEGMENTSEL     	$
#line 173	D:\项目工程\RF-NODC-V1.0-SOFT\src\hw2000b.c ;     hw2000b_write_reg(0x28, 0x8401);//sync_thres:1bit
;  173:(    PARA_1,         40 ,            ,      addr)
...
; ITemplate_CALL
	...
	CALL           	_hw2000b_write_reg		; Bank 0		; ShBank 0
	SEGMENTSEL     	$
#line 174	D:\项目工程\RF-NODC-V1.0-SOFT\src\hw2000b.c ;     hw2000b_write_reg(0x2C, 0x918B);	
;  174:(    PARA_1,         44 ,            ,      addr)
...
; ITemplate_CALL
	...
	CALL           	_hw2000b_write_reg		; Bank 0		; ShBank 0
	SEGMENTSEL     	$
#line 175	D:\项目工程\RF-NODC-V1.0-SOFT\src\hw2000b.c ; 	hw2000b_write_reg(0x2A, 0x40FF);//rate:250kbps     ACK_time:1000us
;  175:(    PARA_1,         42 ,            ,      addr)
...
; ITemplate_CALL
	...
	CALL           	_hw2000b_write_reg		; Bank 0		; ShBank 0
	SEGMENTSEL     	$
#line 176	D:\项目工程\RF-NODC-V1.0-SOFT\src\hw2000b.c ; 	hw2000b_write_reg(0x1A, 0x0D31);
;  176:(    PARA_1,         26 ,            ,      addr)
...
; ITemplate_CALL
	...
	CALL           	_hw2000b_write_reg		; Bank 0		; ShBank 0
	SEGMENTSEL     	$
#line 177	D:\项目工程\RF-NODC-V1.0-SOFT\src\hw2000b.c ; 	hw2000b_write_reg(0x19, 0x0884);
;  177:(    PARA_1,         25 ,            ,      addr)
...
; ITemplate_CALL
	...
	CALL           	_hw2000b_write_reg		; Bank 0		; ShBank 0
	SEGMENTSEL     	$
#line 178	D:\项目工程\RF-NODC-V1.0-SOFT\src\hw2000b.c ; 	hw2000b_write_reg(0x20, 0xF000);//preamble:16 bytes  sync:48 bits
;  178:(    PARA_1,         32 ,            ,      addr)
...
; ITemplate_CALL
	...
	CALL           	_hw2000b_write_reg		; Bank 0		; ShBank 0
	SEGMENTSEL     	$
#line 180	D:\项目工程\RF-NODC-V1.0-SOFT\src\hw2000b.c ; 	hw2000b_write_reg(0x3C, 0x1001);//Enable PIPE0、PIPE0 ACK
;  180:(    PARA_1,         60 ,            ,      addr)
...
; ITemplate_CALL
	...
	SEGMENTSEL     	$
; 	// pipe 0 addr set 
#line 183	D:\项目工程\RF-NODC-V1.0-SOFT\src\hw2000b.c ;     hw2000b_write_reg(0x40, 0x1122); 
;  183:(    PARA_1,         64 ,            ,      addr)
...
; ITemplate_CALL
	...
	CALL           	_hw2000b_write_reg		; Bank 0		; ShBank 0
	SEGMENTSEL     	$
#line 184	D:\项目工程\RF-NODC-V1.0-SOFT\src\hw2000b.c ;     hw2000b_write_reg(0x41, 0x3344); 
;  184:(    PARA_1,         65 ,            ,      addr)
...
; ITemplate_CALL
	...
	CALL           	_hw2000b_write_reg		; Bank 0		; ShBank 0
	SEGMENTSEL     	$
#line 185	D:\项目工程\RF-NODC-V1.0-SOFT\src\hw2000b.c ;     hw2000b_write_reg(0x42, 0x5566); 
;  185:(    PARA_1,         66 ,            ,      addr)
...
; ITemplate_CALL
	...
	CALL           	_hw2000b_write_reg		; Bank 0		; ShBank 0
	SEGMENTSEL     	$
#line 187	D:\项目工程\RF-NODC-V1.0-SOFT\src\hw2000b.c ; 	hw2000b_write_reg(0x23, 0x0500);//re_tx_times:5
;  187:(    PARA_1,         35 ,            ,      addr)
...
; 	//hw2000b_write_reg(0x20, 0xF000);//preamble:16 bytes  sync:48 bits
; 	//}
#line 194	D:\项目工程\RF-NODC-V1.0-SOFT\src\hw2000b.c ; }
;  194:(       RET,            ,            ,          )
...
; {
; 	uint16_t reg;
#line 430	D:\项目工程\RF-NODC-V1.0-SOFT\src\hw2000b.c ; 	hw2000b_irq_request = 0;
	CLR            	BKSR
;  430:(    ASGN_0,          0 ,            ,hw2000b_irq_request)

; ITemplate_CLR_0_TMP
	BCC            	((_hw2000b_irq_request)/8) & 0X7F,	(_hw2000b_irq_request)%8		; Bank 0
; 	
#line 432	D:\项目工程\RF-NODC-V1.0-SOFT\src\hw2000b.c ;     hw2000b_write_reg(0x21, 0x0100);					//TX enable
;  432:(    PARA_1,         33 ,            ,      addr)

; ITemplate_ASGN1_4
	MOVI           	0x21
	MOVAR          	_hw2000b_write_regDATA+0X0		; Bank 1
;  432:(    PARA_2,        256 ,            ,     value)
...
; ITemplate_ASGN1_4
	...
	MOVI           	0x1
	MOVAR          	_hw2000b_write_regDATA+0X1+0x1		; Bank 1
;  432:(      CALL, (hw2000b_write_reg.0) ,            ,          )

; ITemplate_CALL
	SEGMENTSEL     	_hw2000b_write_reg
	CALL           	_hw2000b_write_reg		; Bank 0		; ShBank 0
	SEGMENTSEL     	$
#line 433	D:\项目工程\RF-NODC-V1.0-SOFT\src\hw2000b.c ;     delay_us(5);
;  433:(    PARA_2,          5 ,            ,     delay)
...
; ITemplate_CALL
	...
	SEGMENTSEL     	$
#line 434	D:\项目工程\RF-NODC-V1.0-SOFT\src\hw2000b.c ; 	hw2000b_write_reg(0x3B, 0x8000);					//clear TX FIFO
;  434:(    PARA_1,         59 ,            ,      addr)

; ITemplate_ASGN1_4
	MOVI           	0x3b
	MOVAR          	_hw2000b_write_regDATA+0X0		; Bank 1
;  434:(    PARA_2,      32768 ,            ,     value)
...
; ITemplate_ASGN1_4
	...
	MOVI           	0x80
	MOVAR          	_hw2000b_write_regDATA+0X1+0x1		; Bank 1
;  434:(      CALL, (hw2000b_write_reg.0) ,            ,          )

; ITemplate_CALL
	SEGMENTSEL     	_hw2000b_write_reg
	CALL           	_hw2000b_write_reg		; Bank 0		; ShBank 0
	SEGMENTSEL     	$
#line 435	D:\项目工程\RF-NODC-V1.0-SOFT\src\hw2000b.c ;     hw2000b_write_fifo(0x32, buf, size);				//write FIFO
;  435:(    PARA_1,         50 ,            ,      addr)
...
;  435:(   CVUI_UC,       size ,            ,   #T21388)

; ITemplate_CVSMT
	MOVRA          	_hw2000b_tx_dataDATA+0X2		; Bank 1
	MOVAR          	_hw2000b_tx_data_#T21388_71		; Bank 1
;  435:(    PARA_1,    #T21388 ,            ,    length)

; ITemplate_ASGN1_4
	MOVRA          	_hw2000b_tx_data_#T21388_71		; Bank 1
	MOVAR          	_hw2000b_write_fifoDATA+0X3		; Bank 1
;  435:(      CALL, (hw2000b_write_fifo.0) ,            ,          )

; ITemplate_CALL
	SEGMENTSEL     	_hw2000b_write_fifo
	CALL           	_hw2000b_write_fifo		; Bank 0		; ShBank 0
	SEGMENTSEL     	$
#line 436	D:\项目工程\RF-NODC-V1.0-SOFT\src\hw2000b.c ; 	reg = hw2000b_read_reg(0x36);
;  436:(    PARA_1,         54 ,            ,      addr)

; ITemplate_ASGN1_4
	MOVI           	0x36
	MOVAR          	_hw2000b_read_regDATA+0X0		; Bank 1
;  436:(     CALLR, (hw2000b_read_reg.0) ,            ,       reg)

; ITemplate_CALL
	SEGMENTSEL     	_hw2000b_read_reg
	CALL           	_hw2000b_read_reg		; Bank 0		; ShBank 0
	SEGMENTSEL     	$
	MOVAR          	_hw2000b_tx_data_reg_71		; Bank 1
	MOV            	(?_TMP+0x1) & 0X7F,	0x0		; Bank 0
	MOVAR          	_hw2000b_tx_data_reg_71+0x1		; Bank 1
#line 437	D:\项目工程\RF-NODC-V1.0-SOFT\src\hw2000b.c ; 	hw2000b_write_reg(0x36, 0x0081|reg);				//FIFO0 occupy
;  437:(    PARA_1,         54 ,            ,      addr)

; ITemplate_ASGN1_4
	MOVI           	0x36
	MOVAR          	_hw2000b_write_regDATA+0X0		; Bank 1
;  437:(     BOR_2,        129 ,        reg ,   #T21412)

; ITemplate_BOR1_4
	MOVRA          	_hw2000b_tx_data_reg_71		; Bank 1
	IORI           	0x81
	MOVAR          	_hw2000b_tx_data_#T21412_71		; Bank 1
	MOVRA          	_hw2000b_tx_data_reg_71+0x1		; Bank 1
	IORI           	0x0
	MOVAR          	_hw2000b_tx_data_#T21412_71+0x1		; Bank 1
;  437:(    PARA_2,    #T21412 ,            ,     value)

; ITemplate_ASGN1_4
	MOVRA          	_hw2000b_tx_data_#T21412_71		; Bank 1
	MOVAR          	_hw2000b_write_regDATA+0X1		; Bank 1
	MOVRA          	_hw2000b_tx_data_#T21412_71+0x1		; Bank 1
	MOVAR          	_hw2000b_write_regDATA+0X1+0x1		; Bank 1
...
; ITemplate_CALL
	...
	CALL           	_hw2000b_write_reg		; Bank 0		; ShBank 0
	SEGMENTSEL     	$
#line 438	D:\项目工程\RF-NODC-V1.0-SOFT\src\hw2000b.c ;     hw2000b_write_reg(0x37, 0x0000);					//FIFO1 disable
;  438:(    PARA_1,         55 ,            ,      addr)
...
; ITemplate_ASGN1_4
	...
	MOVI           	0x0
	MOVAR          	_hw2000b_write_regDATA+0X1+0x1		; Bank 1
;  438:(      CALL, (hw2000b_write_reg.0) ,            ,          )

; ITemplate_CALL
	SEGMENTSEL     	_hw2000b_write_reg
	CALL           	_hw2000b_write_reg		; Bank 0		; ShBank 0
	SEGMENTSEL     	$
#line 440	D:\项目工程\RF-NODC-V1.0-SOFT\src\hw2000b.c ; 	while ((!hw2000b_irq_request) && (!RX_OK_flag))
;  440:(     LABEL,    #L21421 ,            ,          )

; ITemplate_LABEL
#L21421
;  440:(     JNZ_0, hw2000b_irq_request ,            ,   #L21423)

; ITemplate_JNZ_0
	JBC            	((_hw2000b_irq_request)/8) & 0X7F,	(_hw2000b_irq_request)%8		; Bank 0
	GOTO           	#L21423
;  440:(     JNZ_1, RX_OK_flag ,            ,   #L21423)
...
; ITemplate_JNZ1_4
	...
	GOTO           	#L21423
; 	{
#line 442	D:\项目工程\RF-NODC-V1.0-SOFT\src\hw2000b.c ; 		CLRWDT();										//清看门狗
; ITemplate_LABEL
;-----------Embedded Asm--------------
	CWDT
;-------------------------------------
#line 443	D:\项目工程\RF-NODC-V1.0-SOFT\src\hw2000b.c ; 		delay_us(5);
;  443:(    PARA_2,          5 ,            ,     delay)
...
; ITemplate_CALL
	...
	CALL           	_delay_us		; Bank 0		; ShBank 0
	SEGMENTSEL     	$
#line 444	D:\项目工程\RF-NODC-V1.0-SOFT\src\hw2000b.c ; 	}
;  444:(       JMP,            ,            ,   #L21421)
...
; 			//{;}
; 	//}
#line 458	D:\项目工程\RF-NODC-V1.0-SOFT\src\hw2000b.c ;     hw2000b_write_reg(0x36, 0x0080);					//FIFO0 no occupy
;  458:(    PARA_1,         54 ,            ,      addr)
...
; ITemplate_ASGN1_4
	...
	MOVI           	0x0
	MOVA           	(_hw2000b_write_regDATA+0X1+0x1) & 0X7F		; Bank 1
;  458:(      CALL, (hw2000b_write_reg.0) ,            ,          )

; ITemplate_CALL
	SEGMENTSEL     	_hw2000b_write_reg
	CALL           	_hw2000b_write_reg		; Bank 0		; ShBank 0
	SEGMENTSEL     	$
#line 459	D:\项目工程\RF-NODC-V1.0-SOFT\src\hw2000b.c ; 	hw2000b_write_reg(0x3D, 0x0008);					//clear int0
;  459:(    PARA_1,         61 ,            ,      addr)
...
; ITemplate_ASGN1_4
	...
	MOVI           	0x0
	MOVAR          	_hw2000b_write_regDATA+0X1+0x1		; Bank 1
;  459:(      CALL, (hw2000b_write_reg.0) ,            ,          )

; ITemplate_CALL
	SEGMENTSEL     	_hw2000b_write_reg
	CALL           	_hw2000b_write_reg		; Bank 0		; ShBank 0
	SEGMENTSEL     	$
#line 460	D:\项目工程\RF-NODC-V1.0-SOFT\src\hw2000b.c ; 	hw2000b_write_reg(0x21, 0x0000);					//TX/RX disable
;  460:(    PARA_1,         33 ,            ,      addr)
...
; ITemplate_ASGN1_4
	...
	MOVI           	0x0
	MOVAR          	_hw2000b_write_regDATA+0X1+0x1		; Bank 1
;  460:(      CALL, (hw2000b_write_reg.0) ,            ,          )

; ITemplate_CALL
	SEGMENTSEL     	_hw2000b_write_reg
	CALL           	_hw2000b_write_reg		; Bank 0		; ShBank 0
	SEGMENTSEL     	$
#line 461	D:\项目工程\RF-NODC-V1.0-SOFT\src\hw2000b.c ; 	hw2000b_write_reg(0x23, 0x431B);					//复位RF状态
;  461:(    PARA_1,         35 ,            ,      addr)

; ITemplate_ASGN1_4
	MOVI           	0x23
	MOVAR          	_hw2000b_write_regDATA+0X0		; Bank 1
;  461:(    PARA_2,      17179 ,            ,     value)
...
; ITemplate_ASGN1_4
	...
	MOVI           	0x43
	MOVAR          	_hw2000b_write_regDATA+0X1+0x1		; Bank 1
;  461:(      CALL, (hw2000b_write_reg.0) ,            ,          )

; ITemplate_CALL
	SEGMENTSEL     	_hw2000b_write_reg
	CALL           	_hw2000b_write_reg		; Bank 0		; ShBank 0
	SEGMENTSEL     	$
#line 462	D:\项目工程\RF-NODC-V1.0-SOFT\src\hw2000b.c ; 	hw2000b_write_reg(0x23, 0x031B);
;  462:(    PARA_1,         35 ,            ,      addr)

; ITemplate_ASGN1_4
	MOVI           	0x23
	MOVAR          	_hw2000b_write_regDATA+0X0		; Bank 1
;  462:(    PARA_2,        795 ,            ,     value)
...
; ITemplate_ASGN1_4
	...
	MOVI           	0x3
	MOVAR          	_hw2000b_write_regDATA+0X1+0x1		; Bank 1
;  462:(      CALL, (hw2000b_write_reg.0) ,            ,          )

; ITemplate_CALL
	SEGMENTSEL     	_hw2000b_write_reg
	CALL           	_hw2000b_write_reg		; Bank 0		; ShBank 0
	SEGMENTSEL     	$
#line 463	D:\项目工程\RF-NODC-V1.0-SOFT\src\hw2000b.c ; }
;  463:(       RET,            ,            ,          )
...
SECTION8D__项目工程_RF_NODC_V1_0_SOFT_src_hw2000b_c_STATIC1	PSECT	FLAG=0X1088,ADDR=0X7FD4F
